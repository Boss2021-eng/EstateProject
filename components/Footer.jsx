    ...
    <footer>
      <section className="sm:min-h-[70vh] lg:min-h-[100vh] w-full bg-black text-white ">
        <main className="w-[95%] mx-auto  p-8 ">
          ...
          <article className="flex justify-end py-24 text-sm lg:text-3xl  ">
            <div className="w-[90%] sm:w-[40%] lg:w-[35%]  p-8 ">
      ...
      <section className="lg:min-h-[100vh] w-full   flex flex-col gap-4  bg-black text-white border-1 border-white w-[95%] mx-auto">
        <main className="lg:p-24 space-y-[30px] lg:space-y-[50px] lg:text-[4vh] p-8">
          ...
          {footerLinks.map((link) => (
            <article className="w-full  gap-16">
              <h3 className="font-medium text-[3vh] lg:text-[5vh] ">Pages </h3>
          ...
          <article className=" w-full md:flex md:gap-48">
            {UtilityPages.map((link) => (
              <div className="md:w-[50%]">
                <p className="font-medium text-[3vh] lg:text-[5vh] ">
                  {link.title}
                </p>
            ...
            <div className="md:w-[50%]">
              <div>
                <h3 className="font-medium text-[3vh] lg:text-[5vh] mb-8">
