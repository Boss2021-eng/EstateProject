      ...
      <main className=" w-[95%] min-h-[50vh] lg:min-h-[100vh] grid grid-cols-3 gap-0 place-items-center  text-[16px] lg:text-[40px] px-[30px] lg:px-[150px] relative text-wrap">
        <article className="col-span-1   ">
          <div className=" flex flex-col items-center justify-center text-center text-white  ">
            <div className="min-w-[200px] min-h-[200px] lg:w-[400px] lg:h-[450px] bg-black  rounded-[50%] flex flex-col items-center justify-center px-2 lg:px-4 py-4 lg:py-8 border-[2px] lg:border-[5px] border-black">
              <h4>25 Years</h4>
              <p>
        ...
        <article className="col-span-1  ">
          <div className=" flex flex-col items-center justify-center text-center ">
            <div className=" min-w-[200px] min-h-[200px] lg:w-[400px] lg:h-[450px] rounded-[50%] flex flex-col items-center justify-center px-2 lg:px-4 py-4 lg:py-8  border-[2px] lg:border-[5px] border-black ">
              <h4>Rent</h4>
              <p>
